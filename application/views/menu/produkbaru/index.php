...
<form action="<?php echo base_url()?>menu/produkbaru/cari" method="post">
    <div class="row">
        <div class="col-lg-8">
            ...
            ?>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a class="btn btn-primary btn-success btn-sm" href="<?php echo site_url('menu/produkbaru/edit/') . $product->idorder; ?>" role="button">Edit</a>
                        <a class="btn btn-primary btn-danger btn-sm" href="<?php echo site_url('menu/produkbaru/delete/') . $product->idorder; ?>" role="button">Hapus</a>
                    </td>
                </tr>

      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">Filter Order</li>
          <li class="breadcrumb-item">
              <a href="<?php echo base_url(); ?>menu/produkbaru">New Order</a>
          </li>
 ...
 <h2>Hapus Data Order</h2>
        <hr />
        <form method="post" action="<?php echo site_url('menu/produkbaru/destroy'); ?>">
        ...
        <hr />
                ...
                <a class="btn btn-primary btn-sm" href="<?php echo site_url('menu/produkbaru')?>" role="submit">Cancel</a>
                </p>
        </form>
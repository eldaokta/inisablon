 ...
 <h2>Hapus Data Order</h2>
        <hr />
        <form method="post" action="<?php echo site_url('menu/masterproduk/destroy'); ?>">
        ...
        <hr />
                ...
                <a class="btn btn-primary btn-sm" href="<?php echo site_url('menu/masterproduk')?>" role="submit">Cancel</a>
                </p>
        </form>
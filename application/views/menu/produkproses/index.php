 <!-- Breadcrumbs-->
      <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Processed Order</li>
      </ol>
          <div class="mb-0 mt-4">
            </div>
...
<form action="<?php echo base_url()?>menu/produkproses/cari" method="post">
    <div class="row">
        <div class="col-lg-8">
            ...
            ?>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a class="btn btn-primary btn-success btn-sm" href="<?php echo site_url('menu/produkproses/edit/') . $product->idorder; ?>" role="button">Edit</a>
                        <a class="btn btn-primary btn-danger btn-sm" href="<?php echo site_url('menu/produkproses/delete/') . $product->idorder; ?>" role="button">Delete</a>
                    </td>
                </tr>
